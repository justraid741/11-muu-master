...
public class YararliLinkler extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yararli_linkler);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            ...
            case R.id.nav_home:
                Intent home=new Intent(YararliLinkler.this, MainActivity.class);
