package com.mind.asvisa.MenuAdds;
...
import com.mind.asvisa.MenuItems.Iletisim;
...
import com.mind.asvisa.MenuItems.OzelHizmetlerimiz;
import com.mind.asvisa.MenuItems.SeyahatSigortasi;
import com.mind.asvisa.R;

public class Guvenlik_duzenlemeleri extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guvenlik_duzenlemeleri);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            ...
            case R.id.nav_home:
                Intent home=new Intent(Guvenlik_duzenlemeleri.this, MainActivity.class);
