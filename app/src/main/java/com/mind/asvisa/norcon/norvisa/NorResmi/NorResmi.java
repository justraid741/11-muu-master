...
public class NorResmi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_resmi);
        ...
        pageHun =new PageNorResmi(getSupportFragmentManager(),pagetab.getTabCount());
