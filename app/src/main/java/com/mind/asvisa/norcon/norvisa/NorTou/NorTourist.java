...
public class NorTourist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_tourist);
        ...
        pageHun =new PageNorTou(getSupportFragmentManager(),pagetab.getTabCount());
