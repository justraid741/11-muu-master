...
public class Iletisim extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            ...
            case R.id.nav_home:
                Intent home=new Intent(Iletisim.this, MainActivity.class);
