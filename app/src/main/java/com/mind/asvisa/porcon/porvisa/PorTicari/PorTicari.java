...
public class PorTicari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_ticari);
        ...
        pageHun =new PagePorTicari(getSupportFragmentManager(),pagetab.getTabCount());
