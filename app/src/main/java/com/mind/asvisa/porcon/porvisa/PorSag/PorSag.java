...
public class PorSag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_sag);
        ...
        pageHun =new PagePorSag(getSupportFragmentManager(),pagetab.getTabCount());
