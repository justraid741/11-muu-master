...
public class PorTransit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_transit);
        ...
        pageHun =new PagePorTran(getSupportFragmentManager(),pagetab.getTabCount());
