...
public class SloSofor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_sofor);
        ...
        pageHun =new PageSloSofor(getSupportFragmentManager(),pagetab.getTabCount());
