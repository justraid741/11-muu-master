package com.mind.asvisa.huncon.hunvisa.HunKult;
...
public class HunKult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hun_kult);
        ...
        pageHun =new PageKult(getSupportFragmentManager(),pagetab.getTabCount());
